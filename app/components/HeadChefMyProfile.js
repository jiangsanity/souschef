...
const HeadChefMyProfile = ({ route, navigation }) => {
    ...
    const showGenerateVoucher = (i) => {
        navigation.navigate("HeadChefGenerateVoucher", {
        });
    }

    const showActiveVouchers = (i) => {
        navigation.navigate("HeadChefActiveVouchers", {
        });
    }
        ...
        <SafeAreaView style={profileViewerStyles.container}>
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View >
                    <TouchableOpacity
                        style={profileViewerStyles.optionWrapper} 
                        onPress={showGenerateVoucher} >
                        <View style={profileViewerStyles.leftWrapper} >
                            <View style={profileViewerStyles.leftText}>
                                <Text style={profileViewerStyles.text, {fontSize: 20}}>Generate Voucher</Text>
                            </View>
                        </View>
                    </TouchableOpacity>
                </View>
                ...
                <View >
                    <TouchableOpacity
                        style={profileViewerStyles.optionWrapper} 
                        onPress={showActiveVouchers} >
                        <View style={profileViewerStyles.leftWrapper} >
                            <View style={profileViewerStyles.leftText}>
                                <Text style={profileViewerStyles.text, {fontSize: 20}}>My Active Vouchers</Text>
                            </View>
                        </View>
                    </TouchableOpacity>
                </View>
...
export default HeadChefMyProfile;
